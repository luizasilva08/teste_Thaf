...
class MenuSetor:
    ...
    def cadastrar_setor(self):
        ...
        try:
            ...
            descricao_setor = input(gradiente_texto("Descrição: ", self.AMARELO, self.AMARELO_CLARO))
    ...
    def buscar_setor(self):
        ...
        if setor is None:
            ...
            print(gradiente_texto(f"Nome........: {setor.nome_setor}", self.AMARELO, self.AMARELO_CLARO))
            print(gradiente_texto(f"Descrição...: {setor.descricao_setor}", self.AMARELO_CLARO, self.AMBAR_ESCURO))
    ...
    def listar_setor(self):
        ...
        for setor in setores:
            print(
                gradiente_texto(
                    f"{setor.id_setor:<5}{setor.nome_setor:<20}{(setor.descricao_setor or ''):<35}",
    ...
    def atualizar_setor(self):
        ...
        nome_setor = input(
            gradiente_texto(f"Nome [{setor.nome_setor}]: ", self.AMBAR_ESCURO, self.AMARELO)
        )
        if nome_setor:
            try:
        ...
        descricao_setor = input(
            gradiente_texto(f"Descrição [{setor.descricao_setor}]: ", self.AMARELO, self.AMARELO_CLARO)
        )
        if descricao_setor:
