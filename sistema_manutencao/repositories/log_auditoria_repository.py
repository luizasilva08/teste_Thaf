...
class LogAuditoriaRepository:
    """logs_auditoria usa soft delete por HERANÇA (ver notas em
    usuario_repository.py) — usa "FROM ONLY logs_auditoria". Além disso,
    log de auditoria não expõe atualizar/excluir no menu: é imutável por
    natureza (RN-003), mesmo que o soft delete existisse na tabela.
    """
